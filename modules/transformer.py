...
class Encoder(tf.keras.layers.Layer):
  def __init__(self, num_layers, d_model, num_heads, dff, maximum_position_encoding, rate=0.1, input_vocab_size = 10000, maxLen = None, doMask=False, doEmbedding=False, seed_value=42):
